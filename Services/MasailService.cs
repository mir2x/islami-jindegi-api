...
public class MasailService(AppDbContext db) : IMasailService
{
    ...
    public async Task<IEnumerable<MasailAuthorOption>> GetAuthorsAsync(bool published)
    {
    ...
    public async Task<IEnumerable<MasailCategoryOption>> GetCategoriesAsync(bool published)
    {
