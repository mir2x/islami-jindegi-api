...
public class ArticleService(AppDbContext db) : IArticleService
{
    ...
    public async Task<IEnumerable<ArticleAuthorOption>> GetAuthorsAsync(bool published)
    {
    ...
    public async Task<IEnumerable<ArticleCategoryOption>> GetCategoriesAsync(bool published)
    {
