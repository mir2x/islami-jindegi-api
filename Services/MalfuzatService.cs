...
public class MalfuzatService(AppDbContext db) : IMalfuzatService
{
    ...
    public async Task<IEnumerable<MalfuzatAuthorOption>> GetAuthorsAsync(bool published)
    {
    ...
    public async Task<IEnumerable<MalfuzatCategoryOption>> GetCategoriesAsync(bool published)
    {
