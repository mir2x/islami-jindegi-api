...
{
    [HttpGet]
    [OutputCache(Duration = 120, Tags = ["books", "authors", "categories"])]
    ...
    [OutputCache(Duration = 300, Tags = ["books"])]
    ...
    [HttpGet("categories")]
    [OutputCache(Duration = 300, Tags = ["books", "categories"])]
    ...
    [HttpGet("{id:guid}")]
    [OutputCache(Duration = 120, Tags = ["books"])]
