...
public static class Mappers
{
    ...
    public static BookListItem ToBookListItem(Book b, int chapterCount = 0) => new(
        ...
        b.CoverUrl, b.DocumentUrl, b.Position, b.PublishedAt, b.Published, b.IsOfflineAvailable,
    ...
    public static DuaListItem ToDuaListItem(Dua d) => new(
        ...
        d.Published, d.IsOfflineAvailable, d.Position, d.CreatedAt, d.UpdatedAt,
    ...
    public static MadrasahDetail ToMadrasahDetail(Madrasah m) => new(
        ...
        m.IsOfflineAvailable, m.CreatedAt, m.UpdatedAt);
    ...
    public static PageListItem ToPageListItem(Page p) => new(
        p.Id, p.Title, p.Slug, p.IsOfflineAvailable, p.CreatedAt, p.UpdatedAt);

    public static PageDetail ToPageDetail(Page p) => new(
        p.Id, p.Title, p.Slug, p.Body, p.ImageUrl, p.IsOfflineAvailable, p.CreatedAt, p.UpdatedAt);
}
